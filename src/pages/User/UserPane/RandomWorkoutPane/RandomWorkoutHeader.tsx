...
const RandomWorkoutHeader = ({ workout }: { workout: RandomWorkout }) => {
  ...
  const targetTimeTenTimes = Math.round(
    ((beatCount * roundCount) / (targetBpm / 60)) * 10
  );
...
export default RandomWorkoutHeader;
